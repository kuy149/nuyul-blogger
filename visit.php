...
echo "$kuning  ___              _
 / _ \ _ __  _   MANG ENGKUR SMD\n";
         
echo "$magenta  ___  _                _
 KUYA PINTAR 😄😄😄😄😄|\n\n";

echo "$biru Only ALUS POKONA :D \n ";
echo " $magenta INFO! ";
echo file_get_contents("https://pastebin.com/raw/k4qabq9K");
echo " \n";
echo "$kuning Contact Me : \n";
echo "$merah YOUTUBE CHANNEL: mang ENGKUR smd \n";
echo "$biru TELEGRAM: KUYA PINTAR \n";
echo " \n \n";
echo "$hijau ~~~~~~ AUTO VISITOR 2020 ~~~~~\n  ";
echo ' Website Mu: ';
